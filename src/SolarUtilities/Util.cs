...
namespace BuildingCoder
{
    internal class Util
    {
      ...
      Debug.Assert( c == c2, "expected shift result to equal multiplication" );
        ...
        private const double _cubicFootToCubicMeter
    ...
    return e;
      ...
      return elementsByName.First<Element>();
        ...
        {
            private static bool _in_revit_2015_or_earlier;
            private static Type _external_definition_creation_options_type;
            ...
            private object NewExternalDefinitionCreationOptions(
              string name,
