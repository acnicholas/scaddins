...
if exist "%RevDir%\Revit 2014\RevitAPI.dll" call %msBuildDir%\msbuild.exe %SWITCHES% /property:Configuration="Release2014" /property:Platform="x64" /target:Clean,Build AngleOfSun.csproj /l:FileLogger,Microsoft.Build.Engine;logfile=var\log\AngleOfSun_MSBuild_Release2014.log || goto :error
