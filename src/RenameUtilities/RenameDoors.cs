...
namespace SCaddins.RenameUtilities
{
    ...
    public class RenameDoors : RenameCandidate
    {
        private FamilyInstance family;

        public RenameDoors(FamilyInstance family)
        {
            this.family = family;
        ...
        public static BindableCollection<RenameParameter> GetParameters(Document doc)
        {
            ...
            foreach (Autodesk.Revit.DB.Parameter param in elem.Parameters)
            {
                ...
                {
                    parametersList.Add(new RenameParameter(param, BuiltInCategory.OST_Doors, null, RenameTypes.Doors));
                }
            }
